    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                xlWorkSheet.Cells.DataSeries(ds.Tables[0].DefaultView);
                /*
                //add data 
                xlWorkSheet.Cells[4, 2] = "";
                xlWorkSheet.Cells[4, 3] = "Student1";
                ...
                */
                ...
                xlWorkBook.SaveAs("d:\\17.xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                xlWorkBook.Close(true, misValue, misValue);
                xlApp.Quit();
